...
- сформировать обогащенный CSV, а в debug-режиме также UTF-8 копию и отдельный лог обработки.
...
7. При включенном debug-режиме приложение дополнительно создает UTF-8 копию результата и отдельный лог обработки для неопределенных шаблонов, конфликтов шаблонов, ошибок валидации и проблем обработки строк.
